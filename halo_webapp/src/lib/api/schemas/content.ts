...
export const contentItemSchema = z
  .object({
    ...
    platform_metadata: z.record(z.string(), z.unknown()).nullable().optional(),
    platformMetadata: z.record(z.string(), z.unknown()).nullable().optional(),
  ...
  .transform((data) => ({
    ...
    platform_metadata: data.platformMetadata ?? data.platform_metadata ?? null,
